...
export class CreatePresentacionDto {
  @ApiProperty({
    ...
    description:
      'Denominación o nombre de la presentación. No puede superar los 255 caracteres.',
    example: '1L',
  })
  ...
  @ApiProperty({
    ...
    minimum: 1,
    description:
      'ID del usuario que crea la presentación. Debe ser un número entero positivo.',
    example: 1,
  })
